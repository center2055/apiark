...
└── CLAUDE.md              # Plan completo de producto e ingeniería
```
...
¡Las contribuciones son bienvenidas! Lee el documento [CLAUDE.md](../../CLAUDE.md) para detalles de arquitectura y convenciones.
