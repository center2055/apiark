...
└── CLAUDE.md              # Plan complet produit et ingénierie
```
...
Les contributions sont les bienvenues ! Lisez le document [CLAUDE.md](../../CLAUDE.md) pour les détails d'architecture et les conventions.
