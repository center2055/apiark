...
└── CLAUDE.md              # Vollständiger Produkt- & Engineering-Plan
```
...
Beiträge sind willkommen! Lies das Dokument [CLAUDE.md](../../CLAUDE.md) für Architekturdetails und Konventionen.
